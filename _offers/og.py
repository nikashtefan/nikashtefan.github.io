...
CARDS = {
    "audit": ("AI-оптимизация процессов", "карта, где теряется время, и одна автоматизация сразу", "первый шаг бесплатно"),
    ...
    "ainative": ("Верните время, которое бизнес теряет на рутине", "отчёты, документы, ответы клиентам — дни превращаются в минуты", "первый шаг бесплатно"),
}
